...
| EPSON Endeavor NJ1000 / Debian 12 i386（32-bit / glibc / EHCI） | Stable v0.1.3 source archive | 合格。native build、CTest、8受信機同時30分soak、direct APDU完走。r7のみ既知個体バースト再現。 | PC/SC IFDは検証対象外。詳細は [Debian 12 i386での検証結果](debian-i686.md) を参照。 |
